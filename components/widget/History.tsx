...
const TimelineItem = ({ year, title, description, alignRight }: any) => {
  return (
    <div className="flex flex-col md:flex-row items-start gap-0 md:gap-14 transition-transform transform hover:scale-105 px-2">
      {alignRight ? (
      ...
      <div className="relative order-1 md:order-2">
        <div className="w-8 h-8 hidden md:block rounded-full border-white border-8 bg-[#517D36] relative z-10 animate-pulse" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="space-y-8">
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute hidden md:block md:left-1/2 transform md:-translate-x-1/2 w-px h-full bg-gray-200" />
